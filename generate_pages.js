...
<body class="text-primaryDark antialiased static-gradient">
    ...
    <!-- NAVIGATION -->
    <div class="fixed top-6 left-0 right-0 z-50 px-6 flex justify-center">
        <nav class="max-w-fit mx-auto pill-nav transition-all duration-300">
            <div class="px-6 py-1 flex items-center justify-between">
                <a href="index.html" class="flex items-center">
                    <img src="images/nova-logo.png" alt="Nova" class="h-28 w-auto transform transition-transform hover:scale-105">
                </a>
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="page2.html" class="nav-link text-primaryDark">
